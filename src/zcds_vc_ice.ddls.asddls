...
@EndUserText.label: 'Report ICE - View Entity Dimension'
...
define view entity ZCDS_VC_ICE
  ...
  inner join zdt_ec_003     as TaxType on TaxType.companycode  = CondicionType.companycode
...
} where CondicionType.typecondition = '3'
group by
