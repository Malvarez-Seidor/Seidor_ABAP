  ...
  as projection on ZCDS_RV_DOC_NDC
{
  ...
  key Billingdocument          as BillingDocument,
      ...
      @Consumption.valueHelpDefinition: [ { entity: { name: 'ZSH_DOC_NDC' , element: 'Sequential' }, distinctValues: true } ]
      ...
      @Consumption.valueHelpDefinition: [ { entity: { name: 'ZSH_DAT_NDC' , element: 'IssueDate' }, distinctValues: true } ]
